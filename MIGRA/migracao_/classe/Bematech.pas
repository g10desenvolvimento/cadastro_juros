...
function Bematech_FI_VerificaEstadoGavetaStr( Estado: String ): Integer; StdCall; External 'BEMAFI32.DLL'; 
...
function Bematech_FI_DownloadMFD( Arquivo: string;
                                  TipoDownload: String;
...
function  capCreateCaptureWindowA(lpszWindowName: pchar; dwStyle: dword; x, y, nWidth,
          nHeight: word; ParentWin: dword; nId: word): dword; stdcall external 'avicap32.dll';
