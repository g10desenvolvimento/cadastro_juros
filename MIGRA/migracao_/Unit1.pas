...
begin
  ...
  try
    ...
    begin
      ...
      begin
        if Trim(Colunas.Strings[j]) = 'CÃ³digo' then
        begin
...
begin
  ...
  try
    ...
    {
    Código : 70001 Ref.: Barra : Produto CALCA MASC. ORD. 104 UND UND
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          Parcela.Titulo.dt_periodofinal   := DataVenc;
          Parcela.Titulo.dt_cadastro       := DataVenc;
          Parcela.Titulo.nm_obs            := 'importação';
...
var
  ...
  sNum: string;
begin
  aNum := 'ABCDEFGHIJLMNOPQRSTUVXZKYWÇ-/0123456789.,\+() ';
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if (Unidade = 'PC') or (Unidade = 'PÇ') then
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        Parcela.Titulo.dt_periodofinal   := DataVenc;
        Parcela.Titulo.dt_cadastro       := DataVenc;
        Parcela.Titulo.nm_obs            := 'importação-'+Doc;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          Parcela.Titulo.dt_periodofinal   := DataVenc;
          Parcela.Titulo.dt_cadastro       := DataVenc;
          Parcela.Titulo.nm_obs            := Obs+#13#10+'importação';
  ...
  try
    ...
    begin
      ...
      begin
        ...
        Emp Doc Título Agên  Conta Dt.Venc. Dt.Doc Vl.Doc.  Al Atz Ep.Bx Dt.Pagto Baixa por: Vl.Multa Vl.Juros Vl.Desc. Vl.Dev. Vl.Pago
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if Trim(Range['A' + IntToStr(I), 'A' + IntToStr(I)].Value2) = 'Média/Atz:' then
           break;
     end;
    end;
